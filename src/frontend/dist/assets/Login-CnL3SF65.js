import { c as createLucideIcon, a8 as useNavigate, a6 as useAuth, r as reactExports, j as jsxRuntimeExports, H as Heart, U as User, P as Phone, d as Button, B as Badge, b as Link, l as ue, a9 as isValidEmail, aa as setToken } from "./index-BC5Mp0jx.js";
...
import { b as apiLogin } from "./api-CYf9rHFU.js";
...
function LoginPage() {
  ...
  const doLogin = async (email2, password2, demoAccount) => {
    setLoading(true);
    try {
      const res = await apiLogin(email2, password2);
      setToken(res.token);
      loginAsRole({
      ...
      ue.success(`Welcome back, ${displayName}!`);
      ...
      if (demoAccount) {
        ...
        ue.success(`Welcome back, ${demoAccount.name.split(" ")[0]}! (demo mode)`);
  ...
  const loginAsDemo = (demo) => doLogin(demo.email, "demo1234", demo);

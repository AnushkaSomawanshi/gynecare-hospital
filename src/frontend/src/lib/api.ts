...
export const PACKAGES_DATA: HealthPackage[] = [
  {
    id: "p1",
    ...
    originalPrice: 4500,
    description:
      "Complete women's health assessment with all essential tests included.",
    tests: [
      "CBC",
      "Thyroid Profile",
      "Pap Smear",
  ...
  },
  {
    ...
    originalPrice: 7500,
    description:
      "Comprehensive prenatal care package for healthy pregnancy management.",
    tests: [
      "Anomaly Scan",
      "NT Scan",
      "Quad Test",
  ...
  },
  {
    ...
    originalPrice: 5200,
    description:
      "Comprehensive fertility evaluation for couples planning a family.",
    tests: [
      "AMH",
      "AFC Count",
      "HSG",
  ...
  },
  {
    ...
    originalPrice: 6000,
    description:
      "Early detection cancer screening for women — cervical, breast, and ovarian.",
    tests: [
      "Pap Smear",
      "HPV Test",
      "CA125",
  ...
  },
  {
    ...
    originalPrice: 3200,
    description:
      "Targeted screening and assessment for PCOS diagnosis and management.",
    tests: [
      "LH/FSH Ratio",
      "Testosterone",
      "DHEAS",
...
export const BLOGS_DATA = [
  ...
  },
  {
    id: "b4",
    title:
      "IVF Success Rates: What Factors Influence Your Journey to Parenthood",
    excerpt:
...
// Mock appointment creation helper
...
export function mapBackendDoctor(_raw: unknown): Doctor {
  return _raw as Doctor;
}

export function mapBackendAppointment(_raw: unknown): Appointment {
  return _raw as Appointment;
}

export function mapBackendRecord(_raw: unknown): MedicalRecord {
  return _raw as MedicalRecord;
}

export function mapBackendLabReport(_raw: unknown): LabReport {
  return _raw as LabReport;
}

export function mapBackendPregnancyTracker(_raw: unknown): PregnancyTracker {
  return _raw as PregnancyTracker;
}
